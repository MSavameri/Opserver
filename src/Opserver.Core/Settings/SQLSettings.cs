...
namespace Opserver
{
    public class SQLSettings : ModuleSettings
    {
        ...
        public int CpuMemoryUsage { get; set; }
        public string SmsSenderBaseUri { get; set; }
        public string SmsSenderRequestUri { get; set; }
        ...
        public class User : ISettingsCollectionItem
        {
